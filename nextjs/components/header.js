...
export default function Header() {
  ...
  return (
    <nav>
      <AppBar position="relative" elevation={0} className={classes.appBarMain}>
      ...
      <AppBar
        position="relative"
        elevation={0}
        className={classes.appBarSecoundary}
      >
        <Container maxWidth="lg">
          <Toolbar className={classes.toolbarSecoundary}>
      ...
      <AppBar
        position="relative"
        elevation={0}
        className={classes.appBarPromostion}
      >
        <Container maxWidth="lg">
          <Toolbar className={classes.toolbarPromotion} />
        </Container>
      </AppBar>
    </nav>
  );
